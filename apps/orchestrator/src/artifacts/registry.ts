...
export const ARTIFACT_TYPES: ArtifactTypeDef[] = [
  {
    ...
    node: "ScriptPlanner",
    description: "Title, hook, and story outline",
  },
  {
    type: "research",
    schema: ResearchOutputSchema,
    node: "ResearchAgent",
    description: "Collected research summary and facts",
  },
  {
    type: "researchQA",
    schema: ResearchQAOutputSchema,
    node: "ResearchQA",
    description: "Research QA verdicts",
  },
  {
    type: "script",
    schema: ScriptWriterOutputSchema,
    node: "ScriptWriter",
    description: "Script, narration, CTA",
  },
  {
    type: "scriptQA",
    schema: ScriptQAOutputSchema,
    node: "ScriptQA",
    description: "Script QA review",
  },
  {
    type: "metadata",
    schema: MetadataOutputSchema,
    node: "MetadataGenerator",
    description: "Video metadata (title, desc, tags)",
  },
  {
    type: "thumbnail",
    schema: ThumbnailOutputSchema,
    node: "ThumbnailGenerator",
    description: "Thumbnail prompt",
  },
  {
    type: "thumbnailImage",
    schema: ThumbnailImageOutputSchema,
    node: "ThumbnailCompositor",
    description: "Rendered 1080x1920 thumbnail with composited text",
  },
  {
    type: "visualDirector",
    schema: VisualDirectorOutputSchema,
    node: "VisualDirector",
    description: "Scene breakdown and visual style per scene",
  },
  {
    type: "prompts",
    schema: ImagePromptOutputSchema,
    node: "ImagePromptGenerator",
    description: "Generation prompts per scene",
  },
  {
    type: "promptQA",
    schema: PromptQAOutputSchema,
    node: "PromptQA",
    description: "Prompt QA review",
  },
  {
    type: "assets",
  ...
  },
  {
    ...
    description: "TTS audio metadata",
  },
  {
    type: "subtitles",
    schema: SubtitlesSchema,
    node: "SubtitleGenerator",
    description: "SRT/ASS subtitles with timestamps",
  },
  {
    type: "videoPlan",
    schema: VideoSchema,
    node: "VideoComposer",
    description: "Composed video metadata",
  },
  {
    type: "releaseValidation",
    schema: ReleaseValidationOutputSchema,
    node: "ReleaseValidation",
    description: "Deterministic release validation",
  },
  {
    type: "releaseReview",
    schema: ReleaseValidationOutputSchema,
    node: "ReleaseReview",
    description: "LLM release review",
  },
  {
    type: "publish",
...
export function getArtifactDefByNode(
  node: string,
): ArtifactTypeDef | undefined {
